...
print("Lowest Math : ", np.min(math))
print("Lowest Science : ", np.min(science))
print("Lowest English : ", np.min(english))
print("Lowest Computer_Science : ",np.min(computer_science))
print("Lowest Social_Studies : ",np.min(social_studies))
